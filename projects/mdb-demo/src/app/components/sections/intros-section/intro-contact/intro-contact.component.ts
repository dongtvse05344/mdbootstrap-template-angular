...
@Component({
  selector: 'app-intro-contact',
  templateUrl: './intro-contact.component.html',
  styleUrls: ['./intro-contact.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class IntroContactComponent implements OnInit, OnDestroy {
