...
@Component({
  selector: 'app-intro-cta',
  templateUrl: './intro-cta.component.html',
  styleUrls: ['./intro-cta.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class IntroCtaComponent implements OnInit, OnDestroy {
