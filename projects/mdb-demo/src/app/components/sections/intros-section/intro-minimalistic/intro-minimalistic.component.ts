...
@Component({
  selector: 'app-intro-minimalistic',
  templateUrl: './intro-minimalistic.component.html',
  styleUrls: ['./intro-minimalistic.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class IntroMinimalisticComponent implements OnInit, OnDestroy {
