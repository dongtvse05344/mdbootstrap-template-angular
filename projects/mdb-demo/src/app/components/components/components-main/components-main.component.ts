...
export class ComponentsMainComponent implements DoCheck {
  ...
  itemsArray = [
    ...
    { id: 6, name: 'Pagination - Basic', description: 'On this page you will find basic example of Angular Pagination', link: '/components/pagination-basic' },
    { id: 6, name: 'Pagination - Advanced', description: 'On this page you will find advanced example of Angular Pagination with table', link: '/components/pagination-advanced' },
    { id: 6, name: 'Pagination - API', description: 'On this page you will find examples of Angular Pagination with table and API', link: '/components/pagination-api' },
    { id: 7, name: 'Progressbars', description: 'On this page you will find examples of Angular Progressbars', link: '/components/progressbars' },
    { id: 8, name: 'Tabs & Pills', description: 'On this page you will find examples of Tabs & Pills', link: '/components/tabs' },
    { id: 9, name: 'Tags, Badges, Labels', description: 'On this page you will find examples of Tags, Badges and Labels', link: '/components/tags' }
  ];
